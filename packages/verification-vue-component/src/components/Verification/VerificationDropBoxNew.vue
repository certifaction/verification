<template>
    <div class="verification-dropbox-new" :class="{dragover:draggingOver}"
        ...
        <div class="dropbox">
            <div class="content">
                ...
                <div class="labels">
                    ...
                    <div class="label subtitle">{{ _$t('verificationNew.dropbox.subtitle') }}</div>
                </div>
            </div>
...
export default {
    ...
    computed: {
        titleLabel() {
            return this.firstVerification ? this._$t('verificationNew.dropbox.title.first') : this._$t('verificationNew.dropbox.title.following')
        }
    },
    methods: {
        handleDrop() {
